...
if __name__ == '__main__':
    TRAIN_SKETCHES_DIR = "../envs/drawing_env/training/32x32_sketches_black_mix_test/"
    VALIDATION_SKETCHES_DIR = "../envs/drawing_env/training/32x32_sketches_black_mix_train/"

    VERSIONS_PER_IMAGE = 20
